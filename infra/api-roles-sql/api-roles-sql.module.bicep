...
resource script_sql_sprintsync 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'sprintsync', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
